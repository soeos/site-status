  ...
  <footer id="footer">
    ...
    <n-flex :size="4" class="text" align="center" vertical>
      ...
      <n-p depth="3">
        ...
        <n-text depth="3" @click="jumpLink(linkData.home)"> ORTECH </n-text>
        <n-text
          v-if="siteIcp"
          depth="3"
...
const linkData = {
  github: "https://github.com/soeos/site-status",
  home: "https://blog.ortech.nyc.mn",
  email: "mailto:admin@ortech.nyc.mn",
};
</script>
